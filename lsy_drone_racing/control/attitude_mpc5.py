...
class MPController(Controller):
    ...
    def __init__(self, obs: dict[str, NDArray[np.floating]], info: dict, config: dict):
        ...
        self.approach_dist = [0.2, 0.3, 0.5, 0.01]
        self.exit_dist = [1.3, 0.3, 0.01, 1]
        ...
        self.exit_height_offset = [0.1, 0.0, -0.05, 0.0]  # Height offset for each gate's exit
    ...
    def _splice_horizon_trajectory(
        self,
        horizon_trajectory: dict[str, np.ndarray],
        current_idx: int,
        horizon_points: int,
